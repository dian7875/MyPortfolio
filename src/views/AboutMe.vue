<template>
    ...
    max-md:flex-col-reverse" id="Start">
  ...
  ">
    ...
    <section class="flex w-11/12 items-center flex-col space-y-4" id="Education">
        <h2 class=" text-3xl font-bold">
            Educación
        </h2>
        <div class=" grid grid-cols-2 gap-10 w-full max-md:grid-cols-1">
